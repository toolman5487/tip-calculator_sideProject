//
//  AccountDetailAnalysisFilterCapsuleCell.swift
//  tip-calculator
//
...
final class AccountDetailAnalysisFilterCapsuleCell: UICollectionViewCell {

    static let reuseId = "AccountDetailAnalysisFilterCapsuleCell"
